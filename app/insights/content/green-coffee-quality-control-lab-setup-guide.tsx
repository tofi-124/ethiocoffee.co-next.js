...
export default function GreenCoffeeQualityControlLabSetupGuide({ title, date, large_image_url }: InsightContentProps) {
  return (
    <>
      ...
      <p className='my-4'>
        Palate calibration is harder and more valuable. The SCA&apos;s Coffee Value Assessment standards SCA-102 through SCA-104 were adopted as the official cupping standards in November 2024 and superseded the 2004 cupping protocol; the <Link href='/insights/new-sca-coffee-value-assessment' className='text-amber-700 hover:underline'>SCA Coffee Value Assessment guide</Link> explains the transition. Pick one system, train every cupper in it, and use the detailed <Link href='/insights/coffee-cupping-calibration-team-protocol' className='text-amber-700 hover:underline font-semibold'>coffee cupping calibration protocol for buying teams</Link> to measure score spread, duplicate repeatability, descriptor alignment, and defect detection. Published SCA standards are available from the <a href='https://sca.coffee/research/coffee-standards' target='_blank' rel='noopener noreferrer' className='text-amber-700 hover:underline'>Specialty Coffee Association standards library</a>.
      </p>
      <p className='my-4'>
