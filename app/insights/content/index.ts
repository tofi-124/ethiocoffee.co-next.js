...
export const insightContentMap: Record<string, () => Promise<any>> = {
  'coffee-cupping-calibration-team-protocol': () =>
    import('./coffee-cupping-calibration-team-protocol').then(mod => mod.default),
  'green-coffee-certificate-of-analysis-buyer-checklist': () =>
    import('./green-coffee-certificate-of-analysis-buyer-checklist').then(mod => mod.default),
  'green-coffee-warehouse-pest-control-guide': () =>
    import('./green-coffee-warehouse-pest-control-guide').then(mod => mod.default),
  'coffee-roasting-weight-loss-yield-cost-guide': () =>
    import('./coffee-roasting-weight-loss-yield-cost-guide').then(mod => mod.default),
  'green-coffee-bag-markings-guide': () =>
    import('./green-coffee-bag-markings-guide').then(mod => mod.default),
  'green-coffee-sampling-protocol': () =>
    import('./green-coffee-sampling-protocol').then(mod => mod.default),
  'green-coffee-sample-roasting-protocol': () =>
    import('./green-coffee-sample-roasting-protocol').then(mod => mod.default),
  'green-coffee-pesticide-residue-testing-guide': () =>
    import('./green-coffee-pesticide-residue-testing-guide').then(mod => mod.default),
  'green-coffee-density-quality-control-protocol': () =>
    import('./green-coffee-density-quality-control-protocol').then(mod => mod.default),
  ...
  'green-coffee-quality-control-lab-setup-guide': () =>
    import('./green-coffee-quality-control-lab-setup-guide').then(mod => mod.default),
  'green-coffee-inventory-management-roasters': () =>
    import('./green-coffee-inventory-management-roasters').then(mod => mod.default),
  'kaffa-coffee-sourcing-guide': () =>
    import('./kaffa-coffee-sourcing-guide').then(mod => mod.default),
  'green-coffee-cargo-insurance-guide': () =>
    import('./green-coffee-cargo-insurance-guide').then(mod => mod.default),
  'ethiopian-coffee-carbon-footprint-scope-3-buyers-guide': () =>
    import('./ethiopian-coffee-carbon-footprint-scope-3-buyers-guide').then(mod => mod.default),
  'ethiopian-coffee-vs-rwandan-coffee': () =>
    import('./ethiopian-coffee-vs-rwandan-coffee').then(mod => mod.default),
  'ethiopian-coffee-vs-sumatran-coffee': () =>
    import('./ethiopian-coffee-vs-sumatran-coffee').then(mod => mod.default),
  'ethiopian-coffee-for-filter-batch-brew-sourcing-guide': () =>
    import('./ethiopian-coffee-for-filter-batch-brew-sourcing-guide').then(mod => mod.default),
  'ethiopian-coffee-for-drip-bags-sourcing-guide': () =>
    import('./ethiopian-coffee-for-drip-bags-sourcing-guide').then(mod => mod.default),
  'ethiopian-coffee-for-instant-soluble-sourcing-guide': () =>
    import('./ethiopian-coffee-for-instant-soluble-sourcing-guide').then(mod => mod.default),
  'ethiopian-coffee-for-capsules-pods-sourcing-guide': () =>
    import('./ethiopian-coffee-for-capsules-pods-sourcing-guide').then(mod => mod.default),
  'ethiopian-coffee-vs-yemeni-coffee': () =>
    import('./ethiopian-coffee-vs-yemeni-coffee').then(mod => mod.default),
  'importing-ethiopian-coffee-to-thailand': () =>
    import('./importing-ethiopian-coffee-to-thailand').then(mod => mod.default),
  'importing-ethiopian-coffee-to-taiwan': () =>
    import('./importing-ethiopian-coffee-to-taiwan').then(mod => mod.default),
  'ethiopian-cup-of-excellence-buyers-guide': () =>
    import('./ethiopian-cup-of-excellence-buyers-guide').then(mod => mod.default),
  'importing-ethiopian-coffee-to-poland': () =>
    import('./importing-ethiopian-coffee-to-poland').then(mod => mod.default),
  'ethiopian-coffee-exporter-vs-broker-vs-trader': () =>
    import('./ethiopian-coffee-exporter-vs-broker-vs-trader').then(mod => mod.default),
  'ethiopian-coffee-incoterms-guide': () =>
    import('./ethiopian-coffee-incoterms-guide').then(mod => mod.default),
  ...
  'green-coffee-mycotoxin-testing-guide': () =>
    import('./green-coffee-mycotoxin-testing-guide').then(mod => mod.default),
  ...
  'green-coffee-specification-sheet-template': () =>
    import('./green-coffee-specification-sheet-template').then(mod => mod.default),
