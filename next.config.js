    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.paypal.com https://*.paypalobjects.com https://challenges.cloudflare.com https://va.vercel-scripts.com https://www.googletagmanager.com https://www.clarity.ms",
              ...
              "frame-src https://*.paypal.com https://*.paypalobjects.com https://challenges.cloudflare.com",
              "object-src 'none'",
              "base-uri 'self'",
            ].join('; '),
          },
